...
const HeroPage = () => {
  return (
    <div
      className="w-full md:h-screen h-[600px]  bg-cover max-sm:bg-bottom-right max-sm:h-[500px]   bg-top-right bg-no-repeat"
    ...
    >
      ...
      <div className="relative w-full md:h-screen h-auto flex justify-center items-center">
        ...
        <div className="content w-full md:h-screen h-[700px] max-sm:h-[500px] absolute top-0 left-0 z-20 flex justify-center items-center">
