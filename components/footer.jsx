...
const Footer = () => {
  ...
  return (
    <div className="w-full text-white h-auto gap-5 flex justify-center items-center p-3">
      <div className=" w-[95%] max-md:w-full bg-[#008141] rounded-2xl relative -z-20 h-auto flex flex-col gap-4 justify-center items-center ">
        <div
          className="w-full h-full  absolute top-0 left-0  bg-cover bg-center opacity-30 -z-10"
          style={{ backgroundImage: `url(${FeaturesBgImage.src})` }}
        >
        </div>
        <div className="footerContent max-sm:justify-center xl:w-[85%] py-10 h-auto flex flex-wrap justify-between mb-3 ">
          <div className="left w-[35%] max-sm:w-[100%] max-[900px]:w-[45%] max-sm:flex max-sm:flex-col max-sm:justify-center justify-start max-sm:items-center p-3 h-auto">
            {/* Logo */}
            <div className="logo ">
